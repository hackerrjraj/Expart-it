...
const listItemVariants = {
  hidden: { opacity: 0 },
  show: { opacity: 1, transition: { duration: 1.5, ease: EASE } },
};
        ...
        {[
          ...
          return (
            <motion.line
              ...
              transition={{ duration: 15, ease: "easeInOut", repeat: Infinity, delay: (i % 6) * 1.2 }}
            />
          );
        })}
        {[
          ...
          <motion.circle
            ...
            transition={{ duration: 15, ease: "easeInOut", repeat: Infinity, delay: (i % 8) * 1.1 }}
          />
        ))}
      </svg>
  ...
  return (
    <motion.div ref={ref} style={{ opacity, scale, x, y, rotate }}>
      <MotionLink
        ...
        className="group relative block cursor-pointer rounded-2xl bg-agency-surface p-6 pb-10 shadow-[0_2px_20px_rgba(0,0,0,0.25)] ring-1 ring-white/10 transition-all duration-500 ease-agency-ease hover:bg-[#191c24] hover:shadow-[0_20px_50px_rgba(0,0,0,0.45)] hover:ring-agency-orange/30"
      >
        {/* animated color wash on hover */}
        <div className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-br from-agency-orange/25 via-agency-accent2/10 to-transparent opacity-0 transition-opacity duration-700 ease-agency-ease group-hover:opacity-100" />

        <h3 className="relative font-display text-xl font-bold leading-snug text-white transition-colors duration-500 group-hover:text-agency-orange">
          {service.title}
        </h3>
        ...
        <div className="mt-6 border-t border-white/10 pt-5">
          <div className="relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-full border border-white/15 py-2.5 text-xs font-bold uppercase tracking-[0.15em] text-white/70 transition-colors duration-300">
            <span className="absolute inset-0 -translate-x-full bg-agency-orange transition-transform duration-500 ease-agency-ease group-hover:translate-x-0" />
            <span className="relative z-10 transition-colors duration-300 group-hover:text-white">Details</span>
            <ArrowRight
              size={14}
              className="relative z-10 transition-transform duration-300 ease-agency-ease group-hover:translate-x-1"
            />
          </div>
        </div>
